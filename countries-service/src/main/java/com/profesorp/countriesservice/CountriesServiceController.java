...
public class CountriesServiceController {
	...
	@GetMapping("/{countryShortcut}")
	public Countries getCountry(@PathVariable String countryShortcut) {
		Countries  countryBean = countriesRepository.findByCountryShortcut(countryShortcut).orElseThrow(() -> new NotFoundException("Country: "+ countryShortcut +" not found"));
